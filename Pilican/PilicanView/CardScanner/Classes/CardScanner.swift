...
public class CardScanner: UIViewController {
    ...
    public var addManually: UIButton?

    public var hintTopText = "Разместите лицевую часть сторону карты в рамке"
    public var hintBottomText = "Коснитесь распознанного значения, чтобы удалить значение и повторите попытку."
    public var buttonConfirmTitle = "Подтвердить"
    public var buttonManuallyTitle = "Добавить карту вручную"
    public var buttonConfirmBackgroundColor: UIColor = .primary
    public var viewTitle = "Сканирование карты"
    ...
    private func addGuideView() {
        ...
        let labelCardNumberY = bottomY - 90
        ...
        labelCardCVV?.textColor = .clear

        let labelHintTopY = bottomY + 20
        ...
        buttonComplete?.titleLabel?.font = .semibold14
        ...
        view.addSubview(addManually!)
        addManually?.translatesAutoresizingMaskIntoConstraints = false
        addManually?.leftAnchor.constraint(equalTo: view.leftAnchor, constant: viewX).isActive = true
        addManually?.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: viewX * -1).isActive = true
        addManually?.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -160).isActive = true
        addManually?.heightAnchor.constraint(equalToConstant: 50).isActive = true
        addManually?.setTitle(buttonManuallyTitle, for: .normal)
        addManually?.titleLabel?.font = .semibold16
