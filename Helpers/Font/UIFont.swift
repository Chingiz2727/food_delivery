...
public extension UIFont {
    ...
    static let semibold18 = UIFont(name: "Montserrat-Semibold", size: 18)!
    static let semibold14 = UIFont(name: "Montserrat-Semibold", size: 14)!
    static let book14 = UIFont(name: "Montserrat-Regular", size: 14)!
    static let book16 = UIFont(name: "Montserrat-Regular", size: 16)!
    static let book12 = UIFont(name: "Montserrat-Regular", size: 12)!
    static let book18 = UIFont(name: "Montserrat-Regular", size: 18)!
    static let book9 = UIFont(name: "Montserrat-Regular", size: 9)!
    static let book8 = UIFont(name: "Montserrat-Regular", size: 8)!
    static let book10 = UIFont(name: "Montserrat-Regular", size: 10)!
    static let medium12 = UIFont(name: "Montserrat-Medium", size: 12)!
    static let medium13 = UIFont(name: "Montserrat-Medium", size: 13)!
    static let medium16 = UIFont(name: "Montserrat-Medium", size: 16)!
    static let medium14 = UIFont(name: "Montserrat-Medium", size: 14)!
    static let medium24 = UIFont(name: "Montserrat-Medium", size: 24)!
    static let medium21 = UIFont(name: "Montserrat-Medium", size: 21)!
    static let medium8 = UIFont(name: "Montserrat-Medium", size: 8)!
